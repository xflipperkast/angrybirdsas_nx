...
#define TRACE_LOG_PATH   GAME_HOME "/angrybirdas_trace.log"
...
/* ETC2 recovery stays enabled, but the heavy diagnostic trace is off in normal
 * builds. Fatal/crash logging is separate and remains enabled. */
#define ENABLE_TRACE_LOG        0
#define TRACE_PUMP_INTERVAL_US  1000000ull
#define TRACE_SLOW_IO_US        12000ull
#define TRACE_SLOW_FRAME_US     24000ull
#define TRACE_LARGE_TEXTURE_PIXELS (512u * 512u)
#define ENABLE_GFX_DIAGNOSTICS  1

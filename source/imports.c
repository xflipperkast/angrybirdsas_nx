...
static int alog_print(int p,const char*t,const char*f,...){(void)p;(void)t;(void)f;return 0;}
static int alog_vprint(int p,const char*t,const char*f,va_list a){(void)p;(void)t;(void)f;(void)a;return 0;}
static int alog_write(int p,const char*t,const char*s){(void)p;(void)t;(void)s;return 0;}
static int alog_buf_write(int b,int p,const char*t,const char*s){(void)b;(void)p;(void)t;(void)s;return 0;}

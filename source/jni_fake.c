...
static void *object_result(void *obj, FakeObj *mid, const JValue *args){
    (void)args; const char *n=mid&&mid->name?mid->name:""; const char *cls=mid&&mid->class_name?mid->class_name:"";
    ...
    if(!strcmp(n,"getSystemService")) return make_object("java/lang/Object");
...
static void *PREFIX##Object(void*e,void*o,void*m,...){(void)e;return object_result(o,as_obj(m),NULL);} \
static void *PREFIX##ObjectV(void*e,void*o,void*m,va_list a){(void)e;(void)a;return object_result(o,as_obj(m),NULL);} \
static void *PREFIX##ObjectA(void*e,void*o,void*m,const JValue*a){(void)e;return object_result(o,as_obj(m),a);} \
